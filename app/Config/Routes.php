...
$routes->group('admin', ['filter' => 'role:admin'], static function ($routes) {
  ...
  $routes->get('books/fetch-isbn', 'BookController::fetchIsbn');
...
$routes->group('member', ['filter' => 'role:member'], static function ($routes) {
  ...
  // HANYA GUNAKAN BARIS INI UNTUK PROSES PINJAM
  $routes->post('loans/borrow/(:num)', 'MemberController::borrow/$1');

  // Ini tetap ke LoanController untuk melihat daftar rekap buku yang dipinjam
